...
namespace Connection_DB
{
    class connection
    {
        ...
        static string database = "salary_organizer";
        static string userDB = "root";
        static string password = "Strongpassword1234";
        ...
        public string getConectData()
        {
            string conData = "server=" + host + ";Database=" + database + ";User ID=" + userDB + ";Password=" + password;
            return conData;
        }
    }
}
